...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Save the products again, now containing the associations
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
        ...
        // For relation OneToOne, we have an alternative way to save
        var pay1 = new Payment(null, Instant.parse("2019-06-20T21:00:00Z"), o1);
        o1.setPayment(pay1);
